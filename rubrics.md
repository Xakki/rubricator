* Транспорт
    ...
    * Грузовики и спецтехника
        * @ Тип* (Эвакуаторы, Строительная, Сельхозтехника, Коммунальная, Лесозаготовительная, Другое)
        * @ Год*
    * Прицепы
        * @ Тип* (Автодома, Прицепы для тягачей, Прицепы для легкого транспорта, Спец. передвижное оборудование, другое)
    * Воздушный транспорт
        * @ Тип* (Пароплан, Вертолет, Самолет)
    * Водный транспорт
        * @ Тип* (Лодка, Байдарка, Катер, Яхта, Баржа, другое судно)
    ...
    * Запчасти и аксессуары
        ...
        * Запчасти
            ...
            * @ Деталь (Авто на запчасти, Автосвет, Аккумуляторы, Двигатель, Трансиссия, Выхломная система, Топливная система, Рулевая система, подвеска, Система охлаждения, Стекла, Кузовные детали, Щетки стеклоочистителя, электрооборудование)
        * Аксессуары
            ...
            * Автоаксессуары
                * @ Тип* (Трос, Лебедки, Дефлекторы, Канистры, Коврики, Чехлы, Органайзеры, Тент, Шторки, Другое)
            * Мотоэкипировка
